...
export type UnitsStackParamList = {
  ...
  Quiz: {topicId: number,  unitId: number, topic: Topic};
  PassedQuiz: {numberQuestions: number, numberCorrect: number, unitId: number, topicId: number},
  FailedQuiz: {unitId: number}
};
