...
app.use(
  expressWinston.logger({
    ...
    msg: "HTTP {{req.method}} {{req.url}} {{res.responseTime}} {{req.body}} {{res.}}ms", // optional: customize the default logging message. E.g. "{{res.statusCode}} {{req.method}} {{res.responseTime}}ms {{req.url}}"
