...
export const MultipleChoiceForm = (props: Props) => {
  ...
  const onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    if (
      ...
      if (initialQuestion) {
        console.log("editing", initialQuestion.id, "to unit:topic", unit_id, ":", topic_id)
        ...
        console.log("adding", question, "to unit:topic", unit_id, ":", topic_id)
